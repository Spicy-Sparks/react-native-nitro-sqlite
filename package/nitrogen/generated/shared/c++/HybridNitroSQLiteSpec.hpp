...
namespace margelo::nitro::rnnitrosqlite {
  ...
  class HybridNitroSQLiteSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<HybridNativeQueryResultSpec> execute(const std::string& dbName, const std::string& query, const std::optional<std::vector<std::variant<bool, std::shared_ptr<ArrayBuffer>, std::string, double, SQLiteNullValue>>>& params, std::optional<bool> ignoreNull) = 0;
      virtual std::shared_ptr<Promise<std::shared_ptr<HybridNativeQueryResultSpec>>> executeAsync(const std::string& dbName, const std::string& query, const std::optional<std::vector<std::variant<bool, std::shared_ptr<ArrayBuffer>, std::string, double, SQLiteNullValue>>>& params, std::optional<bool> ignoreNull) = 0;
